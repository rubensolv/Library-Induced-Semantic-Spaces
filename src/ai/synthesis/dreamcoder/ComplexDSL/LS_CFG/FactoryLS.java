...
import ai.synthesis.dreamcoder.ComplexDSL.LS_Actions.Harvest_LS;
import ai.synthesis.dreamcoder.ComplexDSL.LS_Actions.moveToUnit_LS;
import ai.synthesis.dreamcoder.ComplexDSL.LS_Actions.Idle_LS;
import ai.synthesis.dreamcoder.ComplexDSL.LS_Actions.Attack_LS;
import ai.synthesis.dreamcoder.ComplexDSL.LS_Actions.Build_LS;
import ai.synthesis.dreamcoder.ComplexDSL.LS_Actions.Train_LS;
import ai.synthesis.dreamcoder.ComplexDSL.LS_Actions.MoveAway_LS;
import ai.synthesis.dreamcoder.ComplexDSL.LS_Condition.HasUnitThatKillsInOneAttack_LS;
import ai.synthesis.dreamcoder.ComplexDSL.LS_Condition.OpponentHasUnitInPlayerRange_LS;
import ai.synthesis.dreamcoder.ComplexDSL.LS_Condition.OpponentHasNumberOfUnits_LS;
import ai.synthesis.dreamcoder.ComplexDSL.LS_Condition.HasUnitWithinDistanceFromOpponent_LS;
import ai.synthesis.dreamcoder.ComplexDSL.LS_Condition.HaveQtdUnitsAttacking_LS;
import ai.synthesis.dreamcoder.ComplexDSL.LS_Condition.CanAttack_LS;
import ai.synthesis.dreamcoder.ComplexDSL.LS_Condition.HasLessNumberOfUnit_LS;
import ai.synthesis.dreamcoder.ComplexDSL.LS_Condition.HasNumberOfUnits_LS;
import ai.synthesis.dreamcoder.ComplexDSL.LS_Condition.OpponentHasUnitThatKillsUnitInOneAttack_LS;
import ai.synthesis.dreamcoder.ComplexDSL.LS_Condition.HasUnitInOpponentRange_LS;
import ai.synthesis.dreamcoder.ComplexDSL.LS_Condition.Is_Type_LS;
import ai.synthesis.dreamcoder.ComplexDSL.LS_Condition.HasNumberOfWorkersHarvesting_LS;
import ai.synthesis.dreamcoder.ComplexDSL.LS_Condition.CanHarvest_LS;
import ai.synthesis.dreamcoder.ComplexDSL.LS_Condition.Is_Builder_LS;
import ai.synthesis.dreamcoder.ComplexDSL.Synthesis_Base.CFG.AlmostTerminal;
...
import ai.synthesis.dreamcoder.ComplexDSL.Synthesis_Base.CFG.OpponentPolicy;
import ai.synthesis.dreamcoder.ComplexDSL.Synthesis_Base.CFG.S;
import ai.synthesis.dreamcoder.ComplexDSL.Synthesis_Base.CFG.TargetPlayer;
