...
public class StatisticalData implements EvaluateGS {
	...
	public StatisticalData(int w,int l,int r,int h, int ba, int br, int re) {
		this.worker=w;
		this.light=l;
		this.ranged=r;
		this.heavy=h;
	...
	public StatisticalData(List<Integer> list) {
