...
public class SimplePlayout implements Playout {
    ...
    @Override
    public Pair<Double, StatisticalData> run(GameState gs, UnitTypeTable utt, int player, int max_cycle, AI ai1, AI ai2, boolean exibe) throws Exception {
        // TODO Auto-generated method stub
        StatisticalData eval = new StatisticalData();
        ...
        do {
            ...
            try {
                ...
                if (paraou > 150) {
                    return new Pair<>(-1.0, new StatisticalData());
                }
                if (paraou > 100) {
...
//                System.err.println("Batlle problem run playout 2");
            ...
            gameover = gs2.cycle();
            if (eval instanceof StatisticalData) {
                ((StatisticalData) eval).evaluate(pa1, player);
            } else {
                eval.evaluate(gs2, player);
            }
