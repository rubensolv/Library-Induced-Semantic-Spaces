 ...
 */
package ai.synthesis.dreamcoder.runners.test1;
...
/**
 * Class to test IBR with an empty strategy initialization and a full library from map 24x24
 * @author rubens
 */
public class MainLoopDreamCoderIBREmptyStart {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < NUMBER_OF_ITERATION; i++) {
            ...
            current_solution = runner.run(gs2, 3000, Float.valueOf(0.2f), library);
            ...
            library = shink_frags(frags, MainLoopDreamCoderIBREmptyStart.library);
