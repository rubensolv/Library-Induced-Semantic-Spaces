...
import ai.synthesis.ComplexDSL.DO.DO_T1;
import ai.synthesis.ComplexDSL.DO.DO_noBD;
...
public class Teste3 {
	...
	public static String getMap(String s) {
		...
		if(s.equals("5")) return "maps/32x32/basesWorkers32x32A.xml";
                ...
                if(s.equals("11")) return "maps/letMeOut.xml";
                if(s.equals("12")) return "maps/itsNotSafe.xml";
                if(s.equals("13")) return "maps/barricades24x24.xml";
...
//                if(setting.equals("2")) se= new Algoritmo1( new HC(2000), new DO());
                //if(args[1].equals("2")) se= new Algoritmo1(new HC(2000),new CS_Orig_booster());	
                
                if(setting.equals("3")) se= new Algoritmo1(new HC(2000),new CS_Default());	
                if(setting.equals("4")) se= new Algoritmo1(new HC(500),new CS_Default());	
//                if(setting.equals("4")) se= new Algoritmo1( new HC(2000), new DO_noBD());
                if(setting.equals("5")) se= new Algoritmo1( new HC(2000), new DO_T1());
